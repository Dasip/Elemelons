...
public class UserData {
    @SerializedName("melongame")
    @Expose
    private List<Melongame> melongame = null;
    @SerializedName("id")
    @Expose
    private String id;
    ...
    public List<Melongame> getMelongame() {
        return melongame;
    }

    public void setMelongame(List<Melongame> melongame) {
        this.melongame = melongame;
    }
